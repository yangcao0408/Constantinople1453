...
| # | Card | Ops | Event |
|---|---|---|---|
| 1 | **Zaganos' Sappers** | 2 | Automatically succeeds against one chosen sector's garrison (small Garrison step loss), if Zaganos Pasha is present. |
...
| 3 | **The Sultan's Resolve** | 2 | Ottoman draws 2 extra cards — Mehmed's personal will translates into renewed funding and logistics after a costly week. (Changed from a Morale card — Morale should move only on genuinely weighty, mostly named/unique beats, not routine weekly upkeep.) |
| 4 | **Karaca Pasha's Push** [Requires: Karaca Pasha present] | 2 | +1 Attack to the first Assaults this round on Blachernae and Charisius. |
| 5 | **Ishak Pasha's Push** [Requires: Ishak Pasha present] | 2 | +1 Attack to the first Assaults this round on Gate of the Spring or Golden Gate. |
...
| 7 | **Baltaoğlu's Punishment** [Requires: The Four Ships already played, unique] | 4 | Mehmed publicly disgraces and replaces his admiral after the humiliation of April 20. Ottoman draws 2 extra cards — the reorganized command restores logistics efficiency. **No longer a Morale card (revised this session)** — a public scapegoating doesn't actually put fight back in the army, so it shouldn't read as raising Morale; Ottoman Morale gain is now reserved for exactly two cards, The Hadith of Conquest and The War Council (see the Morale-scarcity policy, Open Questions). |
...
| 9 | **The Serbian Vassals** | 1 | A striking historical irony: Christian troops from the vassal Serbian Despotate served in Mehmed's besieging army under their feudal obligations, even as Constantinople — a fellow Orthodox city — was stormed. Free muster of 2 Azap units this round (no card cost). |
...
| 11 | **The Hadith of Conquest** [Round 1-2 only, unique] | 5 | The ulema invoke the real hadith attributed to Muhammad — "Constantinople will be conquered by a good commander with a good army" — to root the campaign in religious destiny at its outset. Ottoman Morale +1 (lowered from +2 this session, alongside The War Council — see the Morale-scarcity policy, Open Questions). One of only two Ottoman Morale-gain cards in the entire deck, deliberately — it's the strongest religious-legitimacy card available, gated to the campaign's opening and usable once. (Replaces Zeal of the Ghazis, which was too generic for the designated pile — moved to Neutral.) |
...
| 18 | **Fresh Reserves from Anatolia** [Round 5+, unique] | 2 | Provincial reinforcements and volunteer ghazis arrive mid-siege. Immediately deploys 4 Azap and 4 Bashi-bazouk tokens on the board for free. |
| 19 | **Rumeli Fort, the Throat-Cutter** [Before Round 5, unique] | 2 | The great fortress Mehmed built on the Bosphorus in 1452, before the siege proper, its guns sinking any ship that refused to stop — it strangled the city's northern supply line before a single wall was touched. For the rest of the game, the Byzantine "Sue for Aid" target number is 1 harder (§ Sue for Aid mechanic). Flavor-rich and genuinely iconic. |
...
| 22 | **Weight of Numbers** [Round 6+] | 2 | The Ottomans' sheer numerical advantage finally tells as the siege grinds on: the Force Commitment Cap (§6.3) is temporarily 6 instead of 5 for all Assaults this round. |
...
| 24 | **Double Pay Proclaimed** [Round 6+, unique] | 2 | With the siege dragging and the army restless, Mehmed proclaims doubled pay and first rights to the plunder to reignite zeal. Ottoman Draw Track +1 (§4.0) — a real injection of renewed capability, distinct from the Attack-boost of Promise of Plunder. |
| 25 | **The War Council** [Round 7+, unique, Forced] | 5 | Mehmed's real historical council: Halil Pasha argues one last time for lifting the siege, and is overruled. Permanently removes the Mustering Cost (DESIGN.md §6.3) for the rest of the game, and Ottoman Morale +1 (added this session) — the Sultan's will winning out over his own Grand Vizier's doubt is exactly the kind of decisive, army-steadying beat Morale gain should be reserved for. The other of only two Ottoman Morale-gain cards in the deck (with The Hadith of Conquest) — full commitment to throwing elite troops into the fight without restraint. The clearest "point of no return" card in the deck — Forced, since this council happened regardless of either player's preference. |
...
| 11 | **A Merchant's Gold** [Round 2+] | 2 | Wealthy citizens are pressured into funding the defense. Reserve Pool +2. |
| 12 | **The Podestà's Dilemma** [Round 2+] | 3 | Galata's technically-neutral Podestà quietly leaks word of Ottoman cannon positions to old contacts inside the city. +2 Sortie attack power this round when targeting artillery. |
| 13 | **Bells of Defiance** [Round 3+] | 1 | Church bells rung continuously to rally the population and signal alarm. Free Reinforce action this round (no Reserve Pool cost) at any single sector. |
...
| 15 | **Coco's Raid** [Round 4+, Requires: Golden Horn unlocked] | 4 | Attempt to neutralize the Golden Horn threat: on success Ottoman discards 2 cards (ships burned/damaged — this is literally an attempt to torch the fleet, it should cost Ottoman materiel when it works) — but on a bad roll, lose a committed unit and the sector stays active. Real risk, matching Coco's historical death. |
...
| 18 | **The Fausse Braye** [Round 4+] | 4 | The defenders' real practice of packing the battered outer wall and moat with earth-filled barrels and rubble to absorb cannon fire. Choose one sector: its Wall HP cannot drop below the Contested band (§3.1) from Bombardment for the rest of this round and next. |
...
| 20 | **The Stockade at the Breach** [Round 5+, Requires: target sector Breached, unique per sector] | 2 | Giustiniani's real improvised wooden palisade behind the crumbling outer wall at Mesoteichion. A Breached sector permanently gains +1 Wall Defense once built. |
...
| 23 | **Empire's Last Muster** [Round 6+, unique] | 5 | Reserve Pool +3 tokens, one time only — the desperate final call-up of monks, clergy, and every able body left in the city. |
| 24 | **Desperate Muster of Youths** [Round 6+, unique] | 4 | As casualties mount, boys and elderly men are pressed into wall duty. Reserve Pool +2, one time only. |
...
| # | Card | Ops | Event |
|---|---|---|---|
| 1 | **Storm Over the Bosphorus** | 1 | Cancel this round's Bombard phase entirely — bad weather halts the guns. |
...
| 3 | **Rumors of a Relief Fleet** | 2 | Byzantine Reserve Pool +1 — even false rumors of a Hungarian/Venetian relief fleet emboldened the defenders, whatever their effect on the besiegers. (Changed off Ottoman Morale — see the broader Morale-scarcity fix in the notes below.) |
...
| 10 | **The Last Grain Stores** [Round 5+] | 1 | Careful rationing of the city's dwindling food stores. Reserve Pool +1. (Demoted from the Byzantine pile for the same reason — see Zeal of the Ghazis.) |
...
| 4 | **The Winds Shift** | 1 | **[Generic]** Favorable winds aid the fleet: if the Golden Horn is unlocked, +1 Attack on an Assault there this round. | **[Generic]** Favorable winds aid a hoped-for relief ship: +1 to this round's "Sue for Aid" chance (the weather-driven counterpart to the Hungarian Envoy's diplomacy-driven version of the same bonus). |
...
| 11 | **Hunyadi's Truce** [Round 3+] | 2 | **[Historical]** The Hungarian regent John Hunyadi's real truce with the Ottomans holds — no relief ever comes from that quarter, exactly as history records. Negates the Byzantine player's next "Sue for Aid" attempt this game. | **[Unhistorical]** The counterfactual branch: word of the city's desperate plight briefly reignites old crusading fervor and threatens to override the truce. The credible risk of Hunyadi breaking it forces Mehmed to keep forces watching the frontier instead of committing them fully to the siege: Ottoman discards 1 card. (Moved here from the Ottoman pile, where it lived as a single-effect card — the real tension is that Hunyadi's restraint was a choice with a live alternative, which is exactly what dual-use is for.) |
| 12 | **The Venetian Senate's Delay** [Round 3+] | 2 | **[Historical]** The real, documented slow deliberation in the Venetian Senate over committing a relief fleet becomes known in the city, deepening despair as yet another council session ends without a decision. Byzantine Reserve Pool -1. | **[Unhistorical]** The counterfactual branch: Venetian merchants and ship captains already present in the city press their case through back channels, accelerating the Senate's decision. Reserve Pool +2. (Deliberately does *not* touch "Sue for Aid" — that lever already has two negators, Hunyadi's Truce and Intercepted Dispatch; a third would risk over-saturating it.) |
...
| 15 | **Intercepted Dispatch** [Round 4+] | 2 | **[Generic]** Intercepts a Byzantine plea for outside help: negates the Byzantine player's next "Sue for Aid" attempt this game. (Note: stacks with Hunyadi's Truce if both are drawn in the same game — worth a playtesting look at whether that over-cripples the Ops action.) | **[Generic]** Intercepts Ottoman correspondence: disables one enemy leader's flat combat bonus for the next Assault this round. |
| 16 | **The Papal Galleys** [Round 4+] | 3 | **[Historical]** The relief fleet the Pope and Venice were slowly assembling dawdles and never arrives in time — some ships got only as far as the Aegean before turning back. The dashed hope stings: Byzantine Reserve Pool -1. | **[Unhistorical]** The counterfactual: the papal galleys arrive in the nick of time. Reserve Pool +3, and if the Golden Horn is unlocked, it is re-locked (dormant again) as the relief fleet breaks the naval position. The single biggest Byzantine swing in the dual-use set — deliberately high Ops (3) and late-gated to match. (Does *not* touch Sue for Aid, keeping that lever from over-saturating.) |
| 17 | **Terms of Surrender** [Round 8+, unique] | 5 | **[Unhistorical]** A real historical event: Mehmed genuinely offered Constantine safe passage and lordship elsewhere in exchange for peacefully surrendering the city. The psychological weight of a real, tempting offer: Byzantine Reserve Pool -1. | **[Historical]** Constantine's own defiant public refusal of those terms — historically attested — rallies the city instead: Reserve Pool +2. The historical outcome (he refused) is the Byzantine branch; the Ottoman branch is the counterfactual "what if the offer had actually landed." |

## Open Questions

1. **No fixed card-count target for now (per user direction, 2026-07-10).**
   Current counts, this session (2026-07-10, second pass): **Ottoman 28,
   Byzantine 27, Neutral 27 (17 dual-use).** (The Byzantine pile's stated
   count had drifted out of sync with its actual row count after earlier
   trims — renumbered consecutively this pass, and Demetrios
   Kantakouzenos' Stand added as the southern-sector counterpart to
   Theophilos Palaiologos' Vow, mirroring Karaca/Ishak Pasha's Push on
   the Ottoman side; see the Byzantine table.) User intends to skim these
   *down* to a clean per-round draw number, so the piles are still
   deliberately over-provisioned — the read-through pass should prune for
   redundancy/overlap (e.g. Karaca/Ishak Pasha's Push vs Weight of
   Numbers vs The Long Encampment all touch "temporary Attack bonus";
   several late-round-gated cards cluster around rounds 5-8 — check the
   curve isn't lumpy) rather than add more. New this pass: Ottoman flavor
   ...
   Relics Borne Along the Walls, The Fausse Braye); alt-history dual-use
   (The Karamanid Rising, Skanderbeg's Revolt, Prince Orhan's Claim, The
   Papal Galleys).
2. DESIGN.md §2.2 specifies "3-4" designated draws/round, not a flat 3 —
   whatever final count each pile settles at, confirm whether the draw
   rate is meant to be flat at 3 (in which case sizing each pile to
   exactly 9×3=27 makes sense) or genuinely variable (in which case both
   piles need a reshuffle-discard fallback like the Neutral pile has,
...
3. Neutral pile is now at 23 of its ~30-40 target, including 13 dual-use
   ...
   still stacks with Hunyadi's Truce's Ottoman branch (both negate a
   Byzantine "Sue for Aid" attempt) — worth a playtesting look at whether
   that combination over-cripples the Ops action if both land in the
   same game. The Venetian Senate's Delay was deliberately kept off that
   same lever to avoid a third stacking source.
4. Exact reshuffle trigger for the Neutral pile discard (empty-deck
   reshuffle is the default CDG convention — confirm before locking in).
5. A few cards reference mechanics not yet fully specified in DESIGN.md
   ...
   being listed as an Ops action, §2.2) — needs a pass once the Ops action
   list itself is fully specified.
...
7. **Morale-scarcity policy (added 2026-07-09, tightened this session):**
   ...
   routine economic push-and-pull instead. **Morale gain is now capped at
   exactly two cards in the entire deck: The Hadith of Conquest (+1,
   round 1-2 only, unique) and The War Council (+1, round 7+, unique,
   Forced)** — max +2 across a full game. Baltaoğlu's Punishment was
